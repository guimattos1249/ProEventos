...
namespace ProEventos.API.Controllers
{
    ...
    public class EventosController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadImage(int eventoId)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar fazer upload da imagem do evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> Put(int id, EventoDto model)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar alterar evento. Erro: {ex.Message}");
            }
        }
